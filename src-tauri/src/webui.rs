...
fn dispatch_invoke(state: &WebuiState, command: &str, args: Value) -> AppResult<Value> {
    match command {
        ...
        "default_workbuddy_dir" => to_value(settings::default_workbuddy_dir()),
        "default_grok_dir" => to_value(settings::default_grok_dir()),
        "default_dsh_dir" => to_value(settings::default_dsh_dir()),
        "default_hermes_dir" => to_value(settings::default_hermes_dir()),
        ...
        "start_workbench_scan" => to_result_value(crate::workbench_scan::start_workbench_scan(
            ...
            opt_string_arg(&args, "workbuddyDir")?,
            opt_string_arg(&args, "grokDir")?,
            opt_string_arg(&args, "piDir")?,
            opt_string_arg(&args, "dshDir")?,
            opt_string_arg(&args, "hermesDir")?,
            opt_string_arg(&args, "zcodeDir")?,
...
fn provider_dirs_arg(args: &Value) -> AppResult<crate::models::ProviderDirs> {
    Ok(crate::models::ProviderDirs {
        ...
        workbuddy_dir: opt_string_arg(args, "workbuddyDir")?,
        grok_dir: opt_string_arg(args, "grokDir")?,
        dsh_dir: opt_string_arg(args, "dshDir")?,
        hermes_dir: opt_string_arg(args, "hermesDir")?,
        zcode_dir: opt_string_arg(args, "zcodeDir")?,
        pi_dir: opt_string_arg(args, "piDir")?,
